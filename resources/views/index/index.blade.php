...
<div class="row">
    ...
    <div class="accordion" id="accordion-news">
      <div class="card" >
        <div class="card-header card-sports" id="sports">
            <h5>
              <button class="text-white btn btn-link" type="button" data-toggle="collapse" data-target="#sports" aria-expanded="false" aria-controls="sports">
                  Sports
              </button>
            </h5>
        </div>
  ...
  <div class="card">
      <div class="card-header card-enta" id="entertainment">
        <h5>
          <button class="btn btn-link text-white" type="button" data-toggle="collapse" data-target="#entertainment" aria-expanded="false" aria-controls="entertainment">
              Entertainment
          </button>
        </h5>
      </div>
    <div id="entertainment" class="collapse" aria-labelledby="entertainment" data-parent="#accordion-news">
      ...
      <div class="card">
          <div class="card-header  card-business" id="business">
            <h5>
              <button class="btn btn-link text-white" type="button" data-toggle="collapse" data-target="#business" aria-expanded="false" aria-controls="business">
                  Business
              </button>
            </h5>
          </div>
